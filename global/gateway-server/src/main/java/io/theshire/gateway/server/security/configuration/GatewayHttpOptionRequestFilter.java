...
@Component
public class GatewayHttpOptionRequestFilter extends OncePerRequestFilter {
  ...
  public GatewayHttpOptionRequestFilter() {
    super();
  }
  ...
  protected void doFilterInternal(final HttpServletRequest request,
    ...
    if (RequestMethod.OPTIONS.name().equals(request.getMethod())) {
      if (response.getHeader(HttpHeaderConstants.HTTP_HEADER_accessControlAllowOrigin) == null) {
        ...
        response.setHeader(HttpHeaderConstants.HTTP_HEADER_accessControlAllowMethods,
            allowedMethods);
        response.setHeader(HttpHeaderConstants.HTTP_HEADER_accessControlAllowHeaders,
            allowedHeaders);
