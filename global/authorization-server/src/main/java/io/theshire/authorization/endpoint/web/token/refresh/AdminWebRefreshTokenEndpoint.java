...
@RestController
@RequestMapping(value = "/admin/token/refresh", produces = MediaType.APPLICATION_JSON_VALUE)
public class AdminWebRefreshTokenEndpoint extends ManagedRestEndpoint {
  ...
  public ResponseEntity<OAuth2AccessToken>
      httpRefreshPost(@RequestParam("refresh_token") final String refreshToken)
          throws HttpRequestMethodNotSupportedException {
    final Map<String, String> parameters = new HashMap<>();
    parameters.put("grant_type", "refresh_token");
    parameters.put("refresh_token", refreshToken);
    final ClientDetails clDetails = clientDetailsService.loadClientByClientId(internalWebClientId);
