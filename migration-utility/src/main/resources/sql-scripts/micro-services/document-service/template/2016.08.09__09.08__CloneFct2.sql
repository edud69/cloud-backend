...
BEGIN
  ...
  EXECUTE 'INSERT INTO ' || dest_schema || '.document_templates (select * from ' || source_schema || '.document_templates)';
  EXECUTE 'INSERT INTO ' || dest_schema || '.email_document_templates (select * from ' || source_schema || '.email_document_templates)';
